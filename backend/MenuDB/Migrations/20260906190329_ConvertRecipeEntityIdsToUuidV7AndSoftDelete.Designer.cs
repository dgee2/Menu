...
namespace MenuDB.Migrations
{
    ...
    [Migration("20260906190329_ConvertRecipeEntityIdsToUuidV7AndSoftDelete")]
    partial class ConvertRecipeEntityIdsToUuidV7AndSoftDelete
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MenuDB.Data.IngredientEntity", b =>
                {
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("UX_Ingredient_Name");
            ...
            modelBuilder.Entity("MenuDB.Data.MenuUserEntity", b =>
                {
                    ...
                    b.HasIndex("AuthSubject")
                        .IsUnique()
                        .HasDatabaseName("UX_MenuUser_AuthSubject");
            ...
            modelBuilder.Entity("MenuDB.Data.UnitEntity", b =>
                {
                    ...
                    b.HasIndex("Abbreviation")
                        .IsUnique()
                        .HasDatabaseName("UX_Unit_Abbreviation")
                        .HasFilter("[Abbreviation] IS NOT NULL");

                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("UX_Unit_Name");
            ...
            modelBuilder.Entity("MenuDB.Data.UnitTypeEntity", b =>
                {
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("UX_UnitType_Name");
